...
import './init-config';
import { composePageRouter, type DunetaPageRoutes } from 'duneta/middleware/page';
import webRoutes from '../../routes/web';

const routes = webRoutes as DunetaPageRoutes;
export const pageRouter = composePageRouter(routes.pages ?? []);
`,
    );
    return true;
  }
